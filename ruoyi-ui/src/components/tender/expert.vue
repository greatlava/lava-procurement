  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="committeeList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" :disabled="status">
            删除
          </el-button>
        </template>
      </el-table-column>
      ...
      <div>
        ...
        <div class="app-container" style="padding: 10px">
          <el-descriptions class="margin-top" title="抽取申请" style="color: #409eff;" :column="2" border>
            ...
            <el-descriptions-item>
              ...
              <template>
                <el-input v-model="queryParams.xCount" @input="validateInput" :disabled='xWaydialog'
                          id="input-common3"/>
              </template>
            </el-descriptions-item>
            <el-descriptions-item>
            ...
            <el-descriptions-item>
              ...
              <template>
                <el-button type="primary" @click="subApplication" v-show="isType=='add'" :disabled="status">确定
                </el-button>
                <el-button type="primary" @click="updateApplication" v-show="isType=='update'" :disabled="status">修改
                </el-button>
        ...
        <div class="app-container" style="padding: 10px" v-show="queryParams.xWay == 2">
          ...
          <div class="cl">
            ...
            <el-table :data="lTableData" :row-key="row => row.id" @selection-change="lHandleSelectionChange" border
                      stripe
              ...
              <el-table-column label="专家姓名" prop="jName" width="200">
                <template slot-scope="scope">
                  ...
                  <el-dialog title="专家列表" :visible.sync="cpDialog" append-to-body>
                    <el-table ref="singleTable" v-loading="expertLoading" :data="expertList" highlight-current-row
                              style="width: 100%"
        ...
        <div class="app-container" style="padding: 10px" v-show="queryParams.xWay == 1">
          ...
          <el-button style="margin-bottom: 10px;" @click="delRandomExpert" v-show="randomExpertList.length > 0">
            清除专家
          </el-button>
          <div class="cl">
          ...
          <div style="text-align: right;margin-top: 10px;">
            <el-button type="primary" @click="sjcq" v-show="randomExpertList.length > 0" :disabled="status">确定
            </el-button>
            <el-button @click="cancelDrawExerpt">取消</el-button>
          </div>
        </div>
