  ...
  methods: {
    getList(sid) {
      ...
      getTender(sid).then(response=>{
          ...
          this.queryParams.sMust=response.data.sSway.toString();
          this.queryParams.sType=response.data.sMust.toString();
          this.queryParams.sSway=response.data.sType.toString();
